...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/Zyruz-ramu/CinderellaProBot.git)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/Zyruz-ramu/CinderellaProBot.git)
"""
